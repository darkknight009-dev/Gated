    ...
    <main className="auth-page">
      ...
      <section className="auth-main">
        <div className="auth-card">
          ...
          {isSupabaseConfigured ? <Link className="btn btn-primary google-btn" href="/api/auth/google">Continue with Google <ArrowRight size={15} /></Link> : <button className="btn btn-primary google-btn" disabled aria-disabled="true">Google connection unavailable</button>}
